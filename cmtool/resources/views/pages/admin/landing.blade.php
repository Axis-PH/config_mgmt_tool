...
{{-- @include('includes.messages') --}}
    <div style="display: inline-block; width: 600px; border:1px solid black;">
        <h1 style="margin-top:20px; ">管理メニュー</h1>
                    ...
                    <div class="form-group row justify-content-center" style="width:100%;padding-top:15px">
                        <div class="col-md-7" style="padding:5px">
                            <a href="{{ url("/") }}" class="btn btn-primary" 
                                style="font-size:20px; width:100%; height: 100%"> {{ __('Master list') }} </a>
                                {{-- style="font-size:20px; width:100%; height: 100%"> {{ __('マスタ一覧') }} </a> --}}
                        </div>
                        <div class="col-md-7" style="padding:5px">
                            <a href="{{ url('/') }}" class="btn btn-primary" 
                                style="font-size:20px; width:100%; height: 100%"> {{ __('User list') }} </a>
                                {{-- style="font-size:20px; width:100%; height: 100%"> {{ __('ユーザー一覧') }} </a> --}}
                        </div>
                        {{-- <div class="col-md-7" style="padding:5px">
                            <a href="{{ url('/') }}" class="btn btn-primary" 
